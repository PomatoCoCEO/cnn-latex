...
\newcommand\cnnblock[8]{
    ...
    \ifthenelse{\equal{#8}{true}}{\draw[#7!50!black,thick] (xyz cs:x=#1,y=#2,z=#3) -- (xyz cs:x=#1,y=#2+#5,z=#3) node[black,midway,left] {#5};}{\draw[#7!50!black,thick] (xyz cs:x=#1,y=#2,z=#3) -- (xyz cs:x=#1,y=#2+#5,z=#3);}
    \ifthenelse{\equal{#8}{true}}{\draw[#7!50!black,thick] (xyz cs:x=#1,y=#2,z=#3) -- (xyz cs:x=#1+#4,y=#2,z=#3) node[black,midway,below left] {#4};}{\draw[#7!50!black,thick] (xyz cs:x=#1,y=#2,z=#3) -- (xyz cs:x=#1+#4,y=#2,z=#3);}
    \draw[#7!50!black,thick] (xyz cs:x=#1+#4,y=#2,z=#3) -- (xyz cs:x=#1+#4,y=#2,z=#3+#6) node[black,midway,below] {#6}; % no of channels
}

\newcommand\fcblock[6]{
    % args: x,y,z, yHeight, thickness, color
    \simplecuboid{#1}{#2}{#3}{#5}{#4}{#5}{#6}
    % annotate the number of inputs below the layer
    \draw[#6!50!black,thick] (xyz cs:x=#1+1,y=#2,z=#3) -- (xyz cs:x=#1+1,y=#2,z=#3+1) node[black,midway,below] {#4}; % no of channels
